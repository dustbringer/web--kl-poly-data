...
const optionsBM: { [name: string]: string } = {
  ["klpoly-1-9-e=0.05"]: "KL-1-9",
  // ["klpoly-1-9-e=0.3-3rt  "]: "KL-1-9-3rt",
  ["klpoly-1-9-e=0.05-nodupe"]: "KL-1-9-nodupe",
  ["klpoly-1-9-e=0.3-nodupe-3rt"]: "KL-1-9-nodupe-3rt",
  ["klpoly-1-9-e=0.2-nodupe-2rt"]: "KL-1-9-nodupe-sqrt",
  ["hpoly-1-9-e=0.05"]: "H-1-9",
  // ["hpoly-1-9-e=0.3-3rt"]: "H-1-9-3rt",
  ["hpoly-1-9-e=0.05-nodupe"]: "H-1-9-nodupe",
  ["hpoly-1-9-e=0.3-nodupe-3rt"]: "H-1-9-nodupe-3rt",
  ["hpoly-1-9-e=0.2-nodupe-2rt"]: "H-1-9-nodupe-sqrt",
};
...
export default function BallmapperPage() {
  ...
  const [bmInv, setBmInv] = React.useState<string>("klpoly-1-9-e=0.05");
  ...
  const [bmCmpInv, setBmCmpInv] = React.useState<string>("klpoly-1-9-e=0.05");
      ...
      <div>
        ...
        <ul style={{ margin: "0", marginBottom: "1em" }}>
          ...
          <li>
            ...
            ballmapper). Permutations are ordered lexicographically in one-line
            notation. Color of nodes indicate the percentage selected. Nodes are
            semi-transparent so their color is not completely accurate when
            overlapping. To see which permutations live inside each node, see [
