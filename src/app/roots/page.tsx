...
export default function RootsPage() {
  const [type, setType] = React.useState<string>("kl"); // a2, alexander, b1, jones, khovanov-t1
  ...
  React.useEffect(() => {
    fetch(
      staticify(
        `/static/root-grid/${type}-1-10-rootsgridsparse-1000x1000-${resolution}.out`,
      ),
    )
  ...
  return (
    <Container maxWidth="md">
      <Typography variant="body1">
        Select interactive root plot and resolution.
      </Typography>
      <div
        style={{
          margin: "0 .5em",
